...
const web3 = new Web3('https://eth-goerli.g.alchemy.com/v2/')
...
const contractAddress = '0x7ad8092507BA801B147cF7413BC7A412846Be9A9'
...
contract.methods.balanceOf(account1).call((err, balance) => {
  console.log({ err, balance },account1)
})


contract.methods.balanceOf(account2).call((err, balance) => {
  console.log({ err, balance },account2)
})
